...
- `calds_runtime/` contains the runtime contracts, workflow adapter, deterministic truth/search/scoring/review services, WFA risk matrix, sentinel policy, and CLI.
