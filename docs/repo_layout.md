...
- `calds_runtime/` contains the runtime contracts, workflow adapter, deterministic truth/search/scoring/review services, waste/fraud/abuse/mismanagement risk matrix, completion/citation/link-integrity gates, sentinel policy, and CLI.
